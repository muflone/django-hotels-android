...
public class CommandConstants {
    ...
    public static final String SETTING_REPORTS_CREATE_PDF = "reports_create_pdf";
    ...
    public static final String SETTING_REPORTS_ACTIVITIES_TOTALS_TOTAL_SERVICES_FORMAT = "reports_activities_totals_total_services_format";
    ...
    public static final String SETTING_REPORTS_ACTIVITIES_GROUP_FOOTER_TOTAL_SERVICES_FORMAT = "reports_activities_group_footer_total_services_format";
