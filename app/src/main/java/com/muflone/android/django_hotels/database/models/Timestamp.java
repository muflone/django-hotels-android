...
public class Timestamp {
    ...
    public Timestamp(long id, long structureId, long contractId, long directionId, @NonNull Date datetime, @NonNull String description, @Nullable Date transmission) {
        this.id = id;
